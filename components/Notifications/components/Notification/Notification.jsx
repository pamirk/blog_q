...
import NotificationErrorIcon from '../../../../svgs/notification-error-icon';
import NotificationSuccessIcon from '../../../../svgs/notification-success-icon';
import NotificationWarningIcon from '../../../../svgs/notification-warning-icon';
