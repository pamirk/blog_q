...
import Scribble from 'svgs/highlight-triple-underline';
...
const FooterLink = ( props: { children: React.ReactNode; to: string; target?: string; } ) => (
	<li className={cx( 'details-item' )}>
		<Link className={cx( 'link' )} target={props.target} to={props.to}>{props.children}</Link>
	</li>
);
			...
			<div className={cx( 'contents' )}>
				...
				{/*<div className={cx( 'small-links' )}>
					<ul className={cx( 'links' )}>
						...
						<FooterLink target="_blank" to="https://info.wrightsmedia.com/quartz-licensing-reprints-request">Licensing</FooterLink>
					</ul>
				</div>*/}
