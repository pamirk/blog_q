...
export default function ConsentForm() {
    ...
    return (
        <Fragment>
            <Helmet>
                <script async={undefined} custom-element="amp-geo"
                        src="https://cdn.ampproject.org/v0/amp-geo-0.1.js"></script>
                <script async={undefined} custom-element="amp-consent"
                ...
                >
                    <div className={styles.row}>
                        <div className={styles.content}>
                            <p>Welcome to Quartz! Please read our <a href="https://qz.com/about/privacy-policy/">privacy
                                policy</a>.</p>
                            <p><strong>Cookies:</strong> By using this site, you agree to our use of cookies for
                                analytics and personalization.<br/></p>
                            <p><strong>Personal data:</strong> Do you agree to the use of your personal data by Quartz
                                and its partners to serve you targeted ads?</p>
                        </div>
