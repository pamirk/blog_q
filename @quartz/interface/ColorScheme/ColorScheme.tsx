...
import {hexToRGB, minifyCss} from '../../js-utils';
...
export const schemes = {
    LIGHT: {
        ...
        background2: '#ffffff',
        // @ts-ignore
        highlight: createRgba(...hexToRGB('#168dd9'), 0.2),
        typography: '#000000',
    },
    DARK: {
        accent: '#76cbff',
        ...
        background2: '#232634',
        // @ts-ignore
        highlight: createRgba(... hexToRGB('#ff9bde'), 0.25),
        typography: '#ffffff',
    },
    PRINT: {
        accent: '#000',
...
function getCss({accent, background1, background2, highlight, type, typography,}: any) {
