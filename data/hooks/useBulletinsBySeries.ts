import {useBulletinsBySeriesQuery} from '@quartz/content';
...
export default function useBulletinsBySeries(slug: string, perPage = 10, ssr = true) {
    const {data, fetchMore, loading} = useBulletinsBySeriesQuery({
