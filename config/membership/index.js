...
export const allPlans = { ...subscriptionPlans, ...giftPlans, ...deprecatedPlans };
...
export const SUBSCRIBE_EMAIL_STEP = '/subscribe/email/';
export const SUBSCRIBE_PAYMENT_STEP = '/subscribe/payment/';
