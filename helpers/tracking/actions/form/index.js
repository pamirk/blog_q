import { TRACKING } from '../../../../helpers/types/tracking';
import {
...
export { MEMBERSHIP_SIGNUP, PLATFORM_SIGNUP } from './events';
...
export const trackFieldEvent = ( trackingData ) => ( {
	[ TRACKING ]: getFieldEvent( { action: 'click', ...trackingData } ),
	type: 'TRACK_FORM_EVENT',
} );

export const trackCodeValidation = ( ignoredTrackingData, { giftCode, couponCode, code } ) => ( {
	[ TRACKING ]: getCodeValidationEvent( { giftCode, couponCode, code } ),
	type: 'TRACK_FORM_EVENT',
} );
