...
import { GTM, TRACKING, VENT } from '../../../../helpers/types/tracking';
...
// Action creators
export const trackCtaClick = ( { context, ctaName, post, ventName, ...trackingData } ) => ( {
	[ TRACKING ]: {
		[ GTM ]: {
			event: 'CTA',
...
export const trackCtaView = ( { context, ctaName, post, ventName, ...trackingData } ) => ( {
	[ TRACKING ]: {
		[ GTM ]: {
			event: 'CTA',
