 ...
 * @return {Function}
 */
export default function useCaptchaSetup ( useCaptcha, onSubmit, id ) {
		...
		loadScriptOnce( 'https://www.google.com/recaptcha/api.js' )
			.then( () => {
				...
				window.grecaptcha.ready( () => {
					setWidgetId( window.grecaptcha.render( id || CAPTCHA_BUTTON_ID, renderOptions ) );
				} );
			} );

	}, [ hasSetupCaptcha, onSubmit, setHasSetupCaptcha, useCaptcha, id ] );
