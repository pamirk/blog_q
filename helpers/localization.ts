...
const getLocalization = ( args: { dictionary: Dictionary, language: string } ) => {

	function localize( phrase: string, keywords?: { [key: string]: string } ) {
		const translatedPhrase = args.dictionary[args.language]?.[phrase] ?? phrase;
