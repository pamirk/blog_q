...
export const formatDate = ( dateGmt?: Date | string, { dateOnly, human, shortMonth }: { dateOnly?: boolean, human?: boolean; shortMonth?: boolean; } = {} ) => {
...
export const daysFromToday = ( date: Date ) => {
	const secondsRemaining = Math.abs( date.valueOf() - Date.now() ) / 1000;
